...
legend('Case3-VPP-Regulation', ...
    'Case3-VPP-Reserve', ...
    'Case3-VPP-Energy', ...
    'Case4-VPP-Regulation', ...
    'Case4-VPP-Reserve', ...
    'Case4-VPP-Energy', ...
    'FontSize', 12, ...
    'FontName', 'Arial', ...
...
x1 = xlabel('Hour', 'FontSize', 13.5, 'FontName', 'Arial');
y1 = ylabel('Capacity (MW)', 'FontSize', 13.5, 'FontName', 'Arial');
