%% Calculate the revenue of each resource providing frequency regulation
...
for resource_idx = 2 : 4
    ...
    save("../results_basic/result_optimal_bid_ctrl_sep_" + resource_name +".mat", "result", "distribution_der");
